...
use App\Http\Controllers\ResearchFundController;
...
use App\Http\Controllers\ResearchFundApplicationController;
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/', [HomeController::class, 'index'])->name('home')->middleware(RoleMiddleware::class . ':admin');
    Route::get('/dashboard', [HomeController::class, 'index'])->name('home')->middleware(RoleMiddleware::class . ':admin');
    ...
    Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function () {
        ...
        Route::group(['prefix' => 'settings'], function () {
            Route::get('/role-permission', [RolePermission::class, 'index'])->name('role.permission.list')->middleware(RoleMiddleware::class . ':admin');
            Route::resource('permission', PermissionController::class)->middleware(RoleMiddleware::class . ':admin');
            Route::resource('role', RoleController::class)->middleware(RoleMiddleware::class . ':admin');
            Route::resource('users', UserController::class)->middleware(RoleMiddleware::class . ':admin');
        });
...
Route::group(['prefix' => 'auth'], function () {
    ...
    Route::post('register', [HomeController::class, 'register'])->name('auth.register');
