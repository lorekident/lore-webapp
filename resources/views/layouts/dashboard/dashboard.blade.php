...
<body class="">
    ...
    <main class="main-content">
        ...
        <div class="conatiner-fluid card rounded-0">
            <div class="card-body py-3 px-2 d-flex align-items-center"
                style="border-radius:0px !important; border-top: 1px solid #eee;">
                <div class="col-lg-6 fw-bold text-muted text-uppercase px-4">{{ $pageTitle }}</div>
                <div class="col-lg-6 text-end px-4">Dashboard -> <span class="fw-bold">{{ $pageTitle }}</span>
                </div>
            </div>
        </div>
