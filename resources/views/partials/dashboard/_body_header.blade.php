<nav class="nav navbar navbar-expand-lg navbar-light iq-navbar py-3">
                        ...
                        <div class="card shadow-none m-0">
                            ...
                            <div class="card-header d-flex justify-content-between bg-primary py-3">
                                <div class="header-title">
                                    <h5 class="mb-0 text-white">All Notifications ({{$notifications?->count()}})</h5>
                                </div>
                            </div>
                            ...
                            @forelse ($notifications as $notification)
                                <div class="d-flex align-items-center justify-content-between p-3">
                                    <div class="row">
                                    <a href="{{ $notification->data['url'] ?? '#' }}" class="iq-sub-card w-100">
                                        <div class="d-flex align-items-center">
                                            <img class="avatar-40 rounded-pill bg-soft-primary p-1"
                                                src="{{ asset('images/alertImage.png') }}" alt="">
                                ...
                                <form action="{{ route('notifications.destroy', $notification->id) }}" method="POST" class="d-inline">
                                    ...
                                    <div class="d-flex justify-content-between px-5 pb-4">
                                        ...
                                        <button type="submit" class="btn btn-link text-danger p-0">
                                            <x-icons.delete width="20" height="20"/>
                                        </button>
                                    </div>
                                </form>
                                <hr class="mb-1"/>
                                @empty
                                    <p class="p-3">No notifications found.</p>
                                @endforelse
                            </div>
                        </div>
                    </div>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown"
                        ...
                        <div class="caption ms-3 d-none d-md-block ">
                            <h6 class="mb-0 caption-title text-capitalize">
                                {{ auth()->user()->full_name ?? 'Austin Robertson' }}</h6>
