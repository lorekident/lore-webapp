<x-app-layout  :pageTitle="'Add User'" :assets="$assets ?? []">
   <div>
      <?php
         $id = $id ?? null;
      ?>
               ...
               <div class="card-body">
                  <div class="new-user-info">
                        <div class="row">
                           ...
                           <div class="form-group col-md-6">
                              <label class="form-label" for="lname">National No: <span class="text-danger">*</span></label>
                              {{ Form::number('national_no', old('national_no'), ['class' => 'form-control', 'placeholder' => 'National No' ,'required']) }}
                           </div>
                           <div class="form-group col-md-6">
