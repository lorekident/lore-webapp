                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <tbody>
                            @forelse ($this->applications as $application)
                                <tr>
                                    <td>BW/{{str_pad($application->id, 4, '0', STR_PAD_LEFT)}}RFA</td>
                                    <td>BW/{{str_pad($application->id, 4, '0', STR_PAD_LEFT)}}FUND</td>
                                    <td>BW/{{str_pad($application->id, 4, '0', STR_PAD_LEFT)}}RESCH</td>
                                    <td>BW/{{str_pad($application->id, 4, '0', STR_PAD_LEFT)}}PERM</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="text-center">No Soeakers recorded yet...</td>
                                </tr>
                            @endforelse
