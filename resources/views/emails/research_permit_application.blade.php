                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        <tr>
                                            <td style="text-align: center; align-items:center;">
                                                ...
                                                <div class="text-uppercase"><span style="font-size:1rem; font-weight:700; color:#3C4043; text-transform:uppercase; font-family:'Oswald',sans-serif; text-align:center">LORE KID ENTERPRENEURSHIP SYSTEM</span></div>
